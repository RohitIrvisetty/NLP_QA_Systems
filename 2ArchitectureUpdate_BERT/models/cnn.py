...
def _conv_layer(layer, filter_shape, pool_shape, channels_in, channels_out, name="conv_layer"):
    ...
    # Define filter input shape for tf.nn.conv_2d
    ...
    # Perform max pooling on the output
...
def create_cnn_model(is_training,
    ...
    # Reshape token embeddings for use in the convolutional layers
    ...
    # Reshape convolutional layer output for final logits
